...
const UserSettings = ({ dispatch, USER, USER_PROFILE }) => {
      ...
      <Fragment>
        <Paper className="container-inner user" elevation={1}>
          ...
          >
            <TextValidator
              ...
              validators={["required", "isCustomEmail"]}
              errorMessages={["This field is required", "Email id incorrect"]}
              className="field"
              type="text"
              InputLabelProps={{ shrink: true }}
              margin="normal"
        ...
        <ExpansionPanel id="change-password-panel">
          <ExpansionPanelSummary expandIcon={<Icon>expand_more</Icon>}>
            <Typography className="product-panel">Change Password</Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <ValidatorForm onSubmit={submitChangePassword.bind(this)} onError={(errors) => console.log(errors)}>
              ...
              <>
                ...
                <TextValidator
                  ...
                  type="password"
                  name="password"
                  validators={["required", "minChars", "maxChars"]}
                  errorMessages={["this field is required"]}
                  InputLabelProps={{ shrink: true }}
                  margin="normal"
                  variant="outlined"
                ...
                <TextValidator
                  ...
                  validators={["isPasswordMatch", "required", "minChars", "maxChars"]}
                ...
                <Button
                  ...
                  disabled={!(showSubmitButton && oldPassword.length)}
                  type="submit"
                  variant="contained"
                  color="primary"
                >
  ...
  return (
    <div id="profile-page">
      <Header />
      <div id="container">{isLoaded && renderContent()}</div>
      <Footer />
    </div>
  );
};
